...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_criacao, data_atualizacao, ativo, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairo) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp,true, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
